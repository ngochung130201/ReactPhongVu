...
import { Product1 } from "../assets/index.js";
  ...
  return (
    <div className="px-2 ">
      ...
      >
        <SwiperSlide>
          <div className=" ">
            <div className="  bg-white bottom-4 mx-3 px-2 ">
              <a className="" href="/">
                <div className="relative ">
                  <img className="hoverCart h-full " src={Product1} alt="" />,
                  <div className="absolute bottom-[125px]">
                    <Button></Button>
                  </div>
                  <div className=" ml-3 text-left mt-1 ">
                    <h3 className="text-[0.75rem] mt-[-1rem] font-normal leading-4">
                      Google Tivi TCL 4K 65 inch 65P737
                    </h3>

                    <div className="">
                      <a className="text-[#E79C41] text-[0.75rem]" href="/">
                        Còn 1 sản phẩm
                      </a>
                    </div>
                    <div className="">
                      <div className="flex justify-between">
                        <span className="text-textPrice font-bold">
                          12.490.000 đ
                        </span>
                        <svg
                          fill="none"
                      ...
                      <div>
                        <span className="text-textColorMain line-through">
                          {" "}
                          12.490.000 đ{" "}
                        </span>
                        <span className="text-textPrice">-43%</span>
                      </div>
                    </div>
                  </div>
                </div>
